                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Administración de Empleados') }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('empleado.store') }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('Nombre') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="Nombre" id="input-nombre" class="form-control{{ $errors->has('Nombre') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre') }}" value="{{ old('Nombre') }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('ApellidoP') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="ApellidoP" id="input-apellidoP" class="form-control{{ $errors->has('ApellidoP') ? ' is-invalid' : '' }}" placeholder="{{ __('Apellido Paterno') }}" value="{{ old('ApellidoP') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('ApellidoM') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="ApellidoM" id="input-apellidoM" class="form-control{{ $errors->has('ApellidoM') ? ' is-invalid' : '' }}" placeholder="{{ __('Apellido Materno') }}" value="{{ old('ApellidoM') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('CURP') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="CURP" id="input-curp" class="form-control{{ $errors->has('CURP') ? ' is-invalid' : '' }}" placeholder="{{ __('CURP') }}" value="{{ old('CURP') }}" required>
                                        @include('alerts.feedback', ['field' => 'CURP'])
                                    </div>
                                    <div class="form-group{{ $errors->has('Telefono') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-telefono">{{ __('Teléfono') }}</label>
                                        <input type="text" name="Telefono" id="input-telefono" class="form-control{{ $errors->has('Telefono') ? ' is-invalid' : '' }}" placeholder="{{ __('Teléfono') }}" value="{{ old('Telefono') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('Correo') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="email" name="Correo" id="input-correo" class="form-control{{ $errors->has('Correo') ? ' is-invalid' : '' }}" placeholder="{{ __('Correo') }}" value="{{ old('Correo') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('NoContrato') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="NoContrato" id="input-noContrato" class="form-control{{ $errors->has('NoContrato') ? ' is-invalid' : '' }}" required>
                                            ...
                                            @foreach($contratos as $contrato)
                                                <option value="{{ $contrato->NoContrato }}">{{ $contrato->NoContrato }} - {{ $contrato->NombreContrato }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group{{ $errors->has('photo') ? ' has-danger' : '' }} d-flex flex-column">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <img src="{{ asset('img/No Profile Picture.png') }}" alt="...">
                                            </div>
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="input-photo">{{ __('Seleccionar foto de perfil') }}</label>
                                            </div>
                                    ...
                                    <div class="form-group{{ $errors->has('FechaInicioContrato') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="date" name="FechaInicioContrato" id="input-fecha-inicio" class="form-control{{ $errors->has('FechaInicioContrato') ? ' is-invalid' : '' }}" value="{{ old('FechaInicioContrato') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('FechaNacimiento') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="date" name="FechaNacimiento" id="input-fecha-nacimiento" class="form-control{{ $errors->has('FechaNacimiento') ? ' is-invalid' : '' }}" value="{{ old('FechaNacimiento') }}" required>
