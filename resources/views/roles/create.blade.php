                            ...
                            <form method="post" action="{{ route('role.store') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="description" id="input-description" cols="30" rows="10" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}" required>{{ old('description') }}</textarea>
