                            ...
                            <form method="post" action="{{ route('contrato.store') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('NombreContrato') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="NombreContrato" id="input-nombreContrato" class="form-control{{ $errors->has('NombreContrato') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre del Contrato') }}" value="{{ old('NombreContrato') }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('NoContrato') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="NoContrato" id="input-noContrato" class="form-control{{ $errors->has('NoContrato') ? ' is-invalid' : '' }}" placeholder="{{ __('Número de Contrato') }}" value="{{ old('NoContrato') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('EncargadoInterno') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="EncargadoInterno" id="input-encargadoInterno" class="form-control{{ $errors->has('EncargadoInterno') ? ' is-invalid' : '' }}" placeholder="{{ __('Encargado Interno') }}" value="{{ old('EncargadoInterno') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('EncargadoExterno') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="EncargadoExterno" id="input-encargadoExterno" class="form-control{{ $errors->has('EncargadoExterno') ? ' is-invalid' : '' }}" placeholder="{{ __('Encargado Externo') }}" value="{{ old('EncargadoExterno') }}" required>
