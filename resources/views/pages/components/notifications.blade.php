                    ...
                    <div class="card-body">
                        <div class="places-buttons">
                            ...
                            <div class="row">
                                <div class="col-lg-8 ml-auto mr-auto">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <button class="btn btn-outline-default btn-round btn-block"
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                    ...
                                    <div class="modal-dialog modal-notice">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title" id="myModalLabel">How Do You Become an Affiliate?
                                                </h5>
                                            </div>
                                            <div class="modal-body">
                                                <div class="instruction">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="picture">
                                                                <img src="{{ asset('img/bg/daniel-olahs.jpg') }}"
                                                ...
                                                <div class="instruction">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="picture">
                                                                <img src="{{ asset('img/bg/david-marcu.jpg') }}"
                                                                    alt="Thumbnail Image" class="rounded img-raised">
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <!-- end notice modal -->
                                <!-- small modal -->
                                <div class="modal fade modal-primary" id="myModal10" tabindex="-1" role="dialog"
                                    aria-labelledby="myModalLabel" aria-hidden="true">
